function iniciarJuego() {
    ...
    /* Aqui usamos la variable que creamos para manipular el boton-mascota, le agregamos un "escucha, click, que va a disparar la funcion seleccionarMascotaJugador */
}
